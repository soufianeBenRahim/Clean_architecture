...
namespace Clean_Architecture_Soufiane.Infrastructure.Persistence
{
    ...
    public class ApplicationDbContextDesignFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Clean_Architecture_SoufianeDb55;Trusted_Connection=True;MultipleActiveResultSets=true;", options => options.MigrationsAssembly(GetType().Assembly.GetName().Name));
